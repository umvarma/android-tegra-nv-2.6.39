...
/* LCD panel to use */                                                   
/* #define SMBA1002_1280x800PANEL_1 */                                    
/* #define SMBA1002_1280x800PANEL_2 */                                    
/* #define SMBA1002_1366x768PANEL */                                      
#define SMBA1002_1024x600PANEL1 /* The P10AN01 default panel */           
/* #define SMBA1002_1024x600PANEL2 */                                     
...
extern int smba1002_gps_mag_init(void);
extern void smba1002_gps_mag_deinit(void);

extern void smba1002_wlan_bt_poweron(void);
extern void smba1002_wlan_bt_poweroff(void);
extern int smba1002_wlan_bt_init(void);
extern void smba1002_wlan_bt_deinit(void);
...
#if defined(SMBA1002_1280x800PANEL_1)
/* Panel same as Motorola Xoom (tm) */
/* Frame buffer size assuming 16bpp color */
#   define SMBA1002_FB_SIZE TEGRA_ROUND_ALLOC(1280*800*(16/8)*SMBA1002_FB_PAGES)
#elif defined(SMBA1002_1280x800PANEL_2)
/* If using 1280x800 panel (panel upgrade) */
/* Frame buffer size assuming 16bpp color */
#   define SMBA1002_FB_SIZE TEGRA_ROUND_ALLOC(1280*800*(16/8)*SMBA1002_FB_PAGES)
#elif defined(SMBA1002_1366x768PANEL)
/* Frame buffer size assuming 16bpp color */
#   define SMBA1002_FB_SIZE TEGRA_ROUND_ALLOC(1368*768*(16/8)*SMBA1002_FB_PAGES)
#elif defined(SMBA1002_1024x600PANEL1)
/* If using 1024x600 panel (SMBA1002 default panel) */
/* Frame buffer size assuming 16bpp color */
...
/* Frame buffer size assuming 32bpp color and 2 pages for page
 * flipping */
#   define SMBA1002_FB_HDMI_SIZE TEGRA_ROUND_ALLOC(1920*1080*(32/8)*SMBA1002_FB_PAGES)
#else
#   define SMBA1002_FB_HDMI_SIZE TEGRA_ROUND_ALLOC(1280*720*(32/8)*SMBA1002_FB_PAGES)
#endif
